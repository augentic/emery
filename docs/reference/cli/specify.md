...
# Local component, loaded fresh each run.
[[source]]
name = "custom"
adapter = "./adapters/custom.wasm"

# Third-party package: the deployment resolves the registry from the
# namespace; the file names no registry.
[[source]]
name = "third-party"
