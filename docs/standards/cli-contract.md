...
- `refused` — the loader rejected the load: an invalid component, a missing `emery:adapter/source` export, a mismatched digest pin, or a bare name this deployment does not declare; the message names which.
