...
1. **Claims** — every source's Evidence: its key, source kind (`intent` / `documentation` / `behaviour`), and typed claims. This is the complete evidence; nothing else exists.
